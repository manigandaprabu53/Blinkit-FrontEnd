...
function EditAddressDetails({close, data}) {
  ...
  const { register, handleSubmit, reset } = useForm({
    defaultValues:{_id: data._id, address_line: data.address_line, city: data.city, state: data.state, pincode: data.pincode, country: data.country,  mobile: data.mobile}
  });
  ...
  const onSubmit = async (data)=>{
    ...
    try {
      ...
      const response = await api.put(ApiRoutes.updateAddress.path, {_id: data._id, address_line: data.address_line, city: data.city, state: data.state, pincode: data.pincode, country: data.country,  mobile: data.mobile});
