...
function EditProductAdmin({data: propsData, fetchProductData, close}) {
    ...
    try {
        ...
        const response = await api.put(ApiRoutes.updateProductDetails.path, data, {authenticate: ApiRoutes.updateProductDetails.authenticate});
  ...
  return (
    <section className='fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 bg-opacity-70 flex items-center justify-center p-4 z-50'>
        <div className="bg-white w-full max-w-2xl p-4 rounded my-2 h-full max-h-[95vh] overflow-y-auto">
            
            <section>
                <div className='sticky flex items-center justify-between shadow-md p-2 rounded'>
