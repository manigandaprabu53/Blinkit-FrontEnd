...
function EditSubCategory({data, close, fetchData}) {
    ...
    const handleSubmitSubCategory = async (e)=>{
        try {
            e.preventDefault();
            const response = await api.put(ApiRoutes.updateSubCategory.path, subCategoryData, {authenticate: ApiRoutes.updateSubCategory.authenticate});
