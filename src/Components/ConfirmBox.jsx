...
function ConfirmBox({close, confirm, cancel}) {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 p-4 bg-neutral-800 bg-opacity-70 z-50 flex justify-center items-center'>
